...
import com.example.clone.utils.ViewPostFragment;
import com.example.clone.utils.ViewProfileFragment;
...
public class ProfileActivity extends AppCompatActivity implements
    ...
    public void init() {
        Log.d(TAG, "init: inflating11" + getString(R.string.profile_fragment));
        ...
        if(intent.hasExtra(getString(R.string.calling_activity))){
            ...
            if(!user.getUser_id().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                ...
                Log.d(TAG, "init: inflating profile 66");
