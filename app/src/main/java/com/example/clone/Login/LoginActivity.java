    ...
    private void init() {
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isStringNul(email) && isStringNul(password)) {
                    Toast.makeText(mContext, "you must fill out all the feilds", Toast.LENGTH_SHORT).show();
                } else {
                                    ...
                                    if (!task.isSuccessful()) {
                                        ...
                                        try{
                                            if(user.isEmailVerified()){
                                                Log.d(TAG, "onComplete: succcesss. email is verified");
        ...
        //if the user is logged in then navigation to main activity and call finish()
