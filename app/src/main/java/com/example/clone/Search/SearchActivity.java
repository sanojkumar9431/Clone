package com.example.clone.Search;
...
import com.example.clone.utils.UserListAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    private UserListAdapter mAddapter;
    ...
    private void updateUsersList(){
        ...
        mAddapter=new UserListAdapter(SearchActivity.this,R.layout.layout_user_listitem,mUserList);

        mListView.setAdapter(mAddapter);
