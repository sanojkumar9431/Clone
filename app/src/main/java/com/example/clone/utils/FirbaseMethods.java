...
public class FirbaseMethods {
    private static final String TAG = "FirbaseMethods";
    ...
    public FirbaseMethods(Context context){
    ...
    public void uploadNewPhoto(String photoType, final String caption,final int count, String imgUrl,Bitmap bm){
        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))){
            Log.d(TAG, "uploadNewPhoto: uploding new photo");
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mStorageReference
                            .child(filePaths.FIREBASE_iMAGE_STORAGE +"/" +user_id +"/photo"+ (count+1)).getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                        @Override public void onComplete(@NonNull Task<Uri> task) {
                            ...
                            // navigating to the ,main feed so the ruser can see their photo
                ...
                @Override
                public void onProgress(@NonNull UploadTask.TaskSnapshot taskSnapshott) {
                    double progress=(100 * taskSnapshott.getBytesTransferred())/taskSnapshott.getTotalByteCount();
        ...
        // new profile photo
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    mStorageReference
                            .child(filePaths.FIREBASE_iMAGE_STORAGE +"/" +user_id +"/profile_photo").getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                            @Override public void onComplete(@NonNull Task<Uri> task) {
                                Toast.makeText(mContext,"photo upload success",Toast.LENGTH_SHORT).show();
                  ...
                  //  String firebaseUrl=taskSnapshot.getMetadata().getReference().getDownloadUrl().toString();
                    ...
                    // insert into user account setting node
                   // setProfilePhoto(firebaseUrl.toString());
                    setProfilePhoto(firebaseUrl.toString());*/

                    ((AccountSettingActivity)mContext).setViewPager(
                            ((AccountSettingActivity)mContext).pagerAdapter
                                    .getItemPosition(mContext.getString(R.string.edit_profile_fragment))
    ...
    private void addPhotoToDatabase(String caption, String url){
        Log.d(TAG, "addPhotoToDatabase: ading photo to database");
...
// update username in the users node and useraccount setting nodes
...
// add information to the users model  ...   add information to the user account setting
    public void addNewUser(String email,String username,String description,String website,String profile_photo, Long phonenumber){
        User user=new User(userID,12,email,StringManipulation.condenseUsername(username));
    ...
    // retrives the account settings for the user currently loged in
